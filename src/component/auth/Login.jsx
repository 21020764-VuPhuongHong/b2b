  ...
  return (
    <>
      <div className="pt-6 flex flex-col items-center justify-center bg-gray-100">
        <Link to="/">
          <img className="onject-contain w-20 mb-4" src="https://img.lovepik.com/element/45006/8218.png_860.png" alt="amazon-logo" />
        </Link>
        <div className="flex flex-col bg-transparent  px-4 sm:px-6 md:px-8 lg:px-6 py-6 rounded-md w-full max-w-sm border border-gray-300">
          ...
          <div className="mt-4">
            ...
            <p className="text-xs pt-2 pb-6">By continuing, you agree to conditions of Use and Privacy Notice.</p>
          </div>
        </div>
        <div className="grid grid-cols-3 mt-4 gap-2 flex items-center">
          ...
          <div className="col-span-1">
            <div className="text-xs text-gray-600">New user?</div>
          </div>
          <div className="col-span-1">
            <div className="h-[1px] bg-gray-300" />
          </div>
